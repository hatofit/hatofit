...
exports.ApiReport =
  exports.getParsedFromDataDevice =
  exports.getDeviceNameFromDataDeviceType =
    ...
    report: [
      {
        ...
        evaluate: (item) => {
          ...
          if (item.type === "PolarDataType.hr") {
            ...
            const val =
              ((_a = vals[0]) === null || _a === void 0 ? void 0 : _a.hr) ||
              false;
...
const getParsedFromDataDevice = (device) => {
  ...
  const [deviceName, rules] = (0, exports.getDeviceNameFromDataDeviceType)(
    device.type
  );
  // vars
  const reportsItems = [];
      ...
      try {
        ...
        for (const item of session.data) {
          ...
          for (const device of item.devices) {
            ...
            // check data
            const reportsToListAccepted = ["hr", "ecg", "acc"];
        ...
        const report = report_1.ReportSchema.parse({
          ...
          devices,
          exerciseId:
            (_a = session.exercise) === null || _a === void 0 ? void 0 : _a._id,
