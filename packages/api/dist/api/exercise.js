...
const ApiExercises = ({ route }) => {
  ...
  route.post("/exercise", (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      ...
      try {
        ...
        // save to db
        const created = yield db_1.Exercise.create(
          Object.assign(Object.assign({}, exercise), {
  ...
  route.put("/exercise/:id", (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        // validate input
        const exercise = exercise_1.ExerciseSchema.parse(req.body);
        // save to db
        const updated = yield db_1.Exercise.findByIdAndUpdate(
          req.params.id,
          exercise
        );
        // resposne
  ...
  route.delete("/exercise/:id", (req, res) =>
    __awaiter(void 0, void 0, void 0, function* () {
      try {
        // validate input
        const deleted = yield db_1.Exercise.findByIdAndDelete(req.params.id);
        // resposne
        return res.json({
          success: true,
