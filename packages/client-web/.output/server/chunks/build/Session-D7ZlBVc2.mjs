...
import { _ as __nuxt_component_1 } from './Section-DHOkqozb.mjs';
...
import { defineAsyncComponent, defineComponent, computed, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, Suspense, createTextVNode, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
import { u as useFetchWithAuth } from './use-fetch-with-auth-N9InCXnT.mjs';
import { g as getTimeInMorS } from './date-DrT-bfza.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderList } from 'vue/server-renderer';
...
const __nuxt_component_5_lazy = defineAsyncComponent(() => import('./DetailWidget-DCfAB-wd.mjs').then((c) => c.default || c));
const __nuxt_component_6_lazy = defineAsyncComponent(() => import('./StatWidget-I_tSjMHw.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LazySessionWidgetStatWidget = __nuxt_component_6_lazy;
                  ...
                  _push3(ssrRenderComponent(_component_UCard, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`<div class="text-xs"${_scopeId3}>${ssrInterpolate(_ctx.$dayjs((_c = unref(data)) == null ? void 0 : _c.report.startTime).format("dddd, DD MMMM YYYY"))}</div></div><div class="flex gap-1 items-center"${_scopeId3}>`);
                        _push4(ssrRenderComponent(_component_Icon, {
                          name: "fluent:clock-20-regular",
                          class: "text-lg mb-0.5 text-green-500"
                        }, null, _parent4, _scopeId3));
                        _push4(`<div class="text-xs"${_scopeId3}>${ssrInterpolate(_ctx.$dayjs((_d = unref(data)) == null ? void 0 : _d.report.startTime).format("HH:mm:ss"))} - ${ssrInterpolate(_ctx.$dayjs((_e = unref(data)) == null ? void 0 : _e.report.endTime).format("HH:mm:ss"))}</div></div></div>`);
                      } else {
                        return [
                          ...
                          createVNode("div", { class: "flex gap-4 mt-2 items-center" }, [
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(_ctx.$dayjs((_h = unref(data)) == null ? void 0 : _h.report.startTime).format("dddd, DD MMMM YYYY")), 1)
                            ]),
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              createVNode(_component_Icon, {
                                name: "fluent:clock-20-regular",
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(_ctx.$dayjs((_i = unref(data)) == null ? void 0 : _i.report.startTime).format("HH:mm:ss")) + " - " + toDisplayString(_ctx.$dayjs((_j = unref(data)) == null ? void 0 : _j.report.endTime).format("HH:mm:ss")), 1)
                            ])
                          ])
                        ];
                      }
                        ...
                        return [
                          ...
                          createVNode("div", { class: "flex gap-4 mt-2 items-center" }, [
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(_ctx.$dayjs((_c = unref(data)) == null ? void 0 : _c.report.startTime).format("dddd, DD MMMM YYYY")), 1)
                            ]),
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              createVNode(_component_Icon, {
                                name: "fluent:clock-20-regular",
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(_ctx.$dayjs((_d = unref(data)) == null ? void 0 : _d.report.startTime).format("HH:mm:ss")) + " - " + toDisplayString(_ctx.$dayjs((_e = unref(data)) == null ? void 0 : _e.report.endTime).format("HH:mm:ss")), 1)
                            ])
                          ])
                        ];
                      }),
                ...
                if (_push3) {
                  ...
                  if (unref(data)) {
                    ssrRenderSuspense(_push3, {
                      ...
                      default: () => {
                        _push3(ssrRenderComponent(_component_LazySessionWidgetStatWidget, { data: unref(data) }, null, _parent3, _scopeId2));
                      },
                      _: 1
                    });
                  } else {
                  ...
                  return [
                    ...
                    unref(data) ? (openBlock(), createBlock(Suspense, { key: 0 }, {
                      ...
                      default: withCtx(() => [
                        createVNode(_component_LazySessionWidgetStatWidget, { data: unref(data) }, null, 8, ["data"])
                      ]),
                      _: 1
                    })) : createCommentVNode("", true)
                  ];
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Session.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=Session-D7ZlBVc2.mjs.map
