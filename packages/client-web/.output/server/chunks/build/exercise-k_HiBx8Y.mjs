import { j as useToast, e as __nuxt_component_2 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = useFetchWithAuth(Api.Company.Exercises.url(companyId.value));
    const columns = [
      {
        key: "no",
        label: "#"
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div><div class="mb-6"><div class="flex justify-end gap-2">`);
...
//# sourceMappingURL=exercise-k_HiBx8Y.mjs.map
