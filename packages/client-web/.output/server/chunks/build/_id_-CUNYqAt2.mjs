...
const __nuxt_component_7_lazy = defineAsyncComponent(() => import('./DetailWidget-8lte4Hyc.mjs').then((c) => c.default || c));
                  ...
                  _push3(ssrRenderComponent(_component_UCard, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`<div class="text-xs"${_scopeId3}>${ssrInterpolate(unref($dayjs)((_d = unref(data)) == null ? void 0 : _d.report.startTime).format("HH:mm"))}</div></div></div>`);
                      } else {
                        return [
                          createVNode("h2", { class: "text-xl font-semibold" }, toDisplayString(((_f = (_e = unref(data)) == null ? void 0 : _e.exercise) == null ? void 0 : _f.name) || "General"), 1),
                          createVNode("div", { class: "flex gap-4 mt-2 items-center" }, [
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(unref($dayjs)((_g = unref(data)) == null ? void 0 : _g.report.startTime).format("dddd, DD MMMM YYYY")), 1)
                            ]),
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              createVNode(_component_Icon, {
                                name: "fluent:clock-20-regular",
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(unref($dayjs)((_h = unref(data)) == null ? void 0 : _h.report.startTime).format("HH:mm")), 1)
                            ])
                          ])
                        ];
                      }
                        ...
                        return [
                          ...
                          createVNode("div", { class: "flex gap-4 mt-2 items-center" }, [
                            ...
                            createVNode("div", { class: "flex gap-1 items-center" }, [
                              ...
                              createVNode("div", { class: "text-xs" }, toDisplayString(unref($dayjs)((_d = unref(data)) == null ? void 0 : _d.report.startTime).format("HH:mm")), 1)
                            ])
                          ])
                        ];
                      }),
...
//# sourceMappingURL=_id_-CUNYqAt2.mjs.map
