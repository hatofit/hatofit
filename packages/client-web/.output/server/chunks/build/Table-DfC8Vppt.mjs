...
import { m as mergeConfig, b as appConfig, f as useUI, c as __nuxt_component_0$2, e as __nuxt_component_2$1, o as get, _ as _export_sfc } from './server.mjs';
import { u as useFormGroup } from './useFormGroup-4DdrZmPB.mjs';
import { P as upperFirst, d as defu } from '../runtime.mjs';
...
const _sfc_main$2 = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const inputId = (_a = _inputId.value) != null ? _a : useId("$eskp0p2pNz");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({
    class: _ctx.ui.wrapper
  }, _ctx.attrs, _attrs))} data-v-80b168f3>`);
  if (_ctx.indicator || _ctx.$slots.indicator) {
    ssrRenderSlot(_ctx.$slots, "indicator", { percent: _ctx.percent }, () => {
      if (!_ctx.isSteps) {
        _push(`<div class="${ssrRenderClass(_ctx.indicatorContainerClass)}" style="${ssrRenderStyle({ width: `${_ctx.percent}%` })}" data-v-80b168f3><div class="${ssrRenderClass(_ctx.indicatorClass)}" data-v-80b168f3>${ssrInterpolate(Math.round(_ctx.percent))}% </div></div>`);
      } else {
        _push(`<!---->`);
      }
    }, _push, _parent);
  ...
  _push(`<progress${ssrRenderAttrs(mergeProps({ class: _ctx.progressClass }, { value: _ctx.value, max: _ctx.realMax }))} data-v-80b168f3>${ssrInterpolate(_ctx.percent !== void 0 ? `${Math.round(_ctx.percent)}%` : void 0)}</progress>`);
  if (_ctx.isSteps) {
    _push(`<div class="${ssrRenderClass(_ctx.stepsClass)}" data-v-80b168f3><!--[-->`);
    ssrRenderList(_ctx.max, (step, index) => {
      _push(`<div class="${ssrRenderClass(_ctx.stepClasses(index))}" data-v-80b168f3>`);
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-80b168f3"]]);
...
//# sourceMappingURL=Table-DfC8Vppt.mjs.map
