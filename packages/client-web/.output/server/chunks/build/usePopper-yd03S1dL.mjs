import { inject, provide, ref, computed, cloneVNode, h as h$1, Fragment, defineComponent, onMounted, watch, watchEffect, onUnmounted, nextTick } from 'vue';
...
let d = defineComponent({ props: { onFocus: { type: Function, required: true } }, setup(t2) {
  let n2 = ref(true);
  return () => n2.value ? h$1(f$1, { as: "button", type: "button", features: s$1.Focusable, onFocus(o2) {
    o2.preventDefault();
    let e, a2 = 50;
    function r2() {
      var u2;
...
let G = Symbol("TabsSSRContext"), pe = defineComponent({ name: "TabGroup", emits: { change: (a2) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a2, { slots: b2, attrs: s3, emit: o2 }) {
  var w2;
  let i2 = ref((w2 = a2.selectedIndex) != null ? w2 : a2.defaultIndex), l2 = ref([]), r2 = ref([]), x = computed(() => a2.selectedIndex !== null), P2 = computed(() => x.value ? a2.selectedIndex : i2.value);
  function y2(t2) {
    var c2;
    let n2 = O(u2.tabs.value, o$2), d2 = O(u2.panels.value, o$2), e = n2.filter((I2) => {
      var p2;
      return !((p2 = o$2(I2)) != null && p2.hasAttribute("disabled"));
    });
    if (t2 < 0 || t2 > n2.length - 1) {
      let I2 = u$3(i2.value === null ? 0 : Math.sign(t2 - i2.value), { [-1]: () => 1, [0]: () => u$3(Math.sign(t2), { [-1]: () => 0, [0]: () => 0, [1]: () => 1 }), [1]: () => 0 }), p2 = u$3(I2, { [0]: () => n2.indexOf(e[0]), [1]: () => n2.indexOf(e[e.length - 1]) });
      p2 !== -1 && (i2.value = p2), u2.tabs.value = n2, u2.panels.value = d2;
    } else {
      let I2 = n2.slice(0, t2), D = [...n2.slice(t2), ...I2].find((W) => e.includes(W));
      if (!D)
        return;
  ...
  let u2 = { selectedIndex: computed(() => {
    ...
    P2.value !== t2 && o2("change", t2), x.value || y2(t2);
  }, registerTab(t2) {
    var e;
    ...
    let d2 = (e = l2.value.indexOf(n2)) != null ? e : i2.value;
    d2 !== -1 && (i2.value = d2);
  }, unregisterTab(t2) {
  ...
  let R = computed(() => a2.selectedIndex);
  return onMounted(() => {
    watch([R], () => {
      var t2;
    ...
    if (!x.value || P2.value == null || u2.tabs.value.length <= 0)
      return;
    let t2 = O(u2.tabs.value, o$2);
    t2.some((d2, e) => o$2(u2.tabs.value[e]) !== o$2(d2)) && u2.setSelectedIndex(t2.findIndex((d2) => o$2(d2) === o$2(u2.tabs.value[P2.value])));
  }), () => {
...
} }), me = defineComponent({ name: "TabList", props: { as: { type: [Object, String], default: "div" } }, setup(a2, { attrs: b2, slots: s3 }) {
  let o2 = C("TabList");
  return () => {
  ...
  let x = inject(G), P$1 = computed(() => {
    if (x.value) {
      let e = x.value.tabs.indexOf(i2);
      return e === -1 ? x.value.tabs.push(i2) - 1 : e;
    }
    return -1;
  }), y2 = computed(() => {
  ...
  function T2(e) {
    ...
    if (c2 === T$1.Success && l2.activation.value === "auto") {
      let p2 = (I2 = i$3(r2)) == null ? void 0 : I2.activeElement, D = l2.tabs.value.findIndex((O2) => o$2(O2) === p2);
      D !== -1 && l2.setSelectedIndex(D);
    }
    return c2;
  }
  function m(e) {
    let c2 = l2.tabs.value.map((p2) => o$2(p2)).filter(Boolean);
    ...
    if (T2(() => u$3(l2.orientation.value, { vertical() {
  ...
  function w2() {
    var e;
    R.value || (R.value = true, !a2.disabled && ((e = o$2(r2)) == null || e.focus({ preventScroll: true }), l2.setSelectedIndex(y2.value), t(() => {
      R.value = false;
    })));
  }
  function t$12(e) {
  ...
  let n2 = s$2(computed(() => ({ as: a2.as, type: b2.type })), r2);
  return () => {
    var p2;
    let e = { selected: u2.value }, { ...c2 } = a2, I2 = { ref: r2, onKeydown: m, onMousedown: t$12, onClick: w2, id: i2, role: "tab", type: n2.value, "aria-controls": (p2 = o$2(l2.panels.value[y2.value])) == null ? void 0 : p2.id, "aria-selected": u2.value, tabIndex: u2.value ? 0 : -1, disabled: a2.disabled ? true : void 0 };
  ...
  let x = inject(G), P2 = computed(() => {
    ...
    let m = l2.panels.value.indexOf(r2);
    return m === -1 ? P2.value : m;
  }), u2 = computed(() => y2.value === l2.selectedIndex.value);
  return () => {
    var n2;
    let m = { selected: u2.value }, { tabIndex: R, ...w2 } = a2, t2 = { ref: r2, id: i2, role: "tabpanel", "aria-labelledby": (n2 = o$2(l2.tabs.value[y2.value])) == null ? void 0 : n2.id, tabIndex: u2.value ? R : -1 };
    return !u2.value && a2.unmount && !a2.static ? h$1(f$1, { as: "span", "aria-hidden": true, ...t2 }) : A({ ourProps: t2, theirProps: w2, slot: m, attrs: b2, slots: s3, features: N.Static | N.RenderStrategy, visible: u2.value, name: "TabPanel" });
  };
} });
...
export { A, s$2 as B, i$1 as C, p as D, u$1 as E, usePopper as F, f as G, c as H, Ie as I, v$1 as J, E as K, n$1 as L, N, O, P, S$1 as S, T, _, I$1 as a, i as b, s2 as c, S as d, t$1 as e, f$1 as f, c$2 as g, l$1 as h, i$3 as i, w$1 as j, N$1 as k, l, me as m, T$1 as n, o$2 as o, pe as p, o$1 as q, t$2 as r, s$1 as s, t, u$3 as u, w$2 as v, w, xe as x, ye as y, h as z };
//# sourceMappingURL=usePopper-yd03S1dL.mjs.map
