...
import { e as __nuxt_component_2$1, k as __nuxt_component_2$1$1 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Icon = __nuxt_component_2$1$1;
...
//# sourceMappingURL=index-boG3IfUu.mjs.map
