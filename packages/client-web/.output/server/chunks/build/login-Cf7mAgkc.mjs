...
import { m as mergeConfig, b as appConfig, c as __nuxt_component_1$1, d as __nuxt_component_1, e as __nuxt_component_2, f as useUI, g as useSeoMeta, h as useAuth, i as useRoute, a as __nuxt_component_0$2, _ as _export_sfc } from './server.mjs';
import { defineComponent, toRef, computed, useSSRContext, reactive, ref, mergeProps, withCtx, createTextVNode, createVNode, unref } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(mode) === "login") {
        ...
        _push(` if you don&#39;t have an account. </p></div></div>`);
...
//# sourceMappingURL=login-Cf7mAgkc.mjs.map
