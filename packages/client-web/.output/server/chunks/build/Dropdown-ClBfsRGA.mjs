import { G as arrow, m as mergeConfig, b as appConfig, f as useUI, c as __nuxt_component_0$2, d as __nuxt_component_1$1, H as getNuxtLinkProps, _ as _export_sfc, a as __nuxt_component_0$3 } from './server.mjs';
...
import { w, v as w$2, z as h, o as o$2, g as t, d as u$4, c as i, A as A$1, a as I$1, B as s$1, C as i$1, b as l, N, D as p, E as u$2, F as usePopper, l as l$1, G as f, H as c, q as o$1, J as v$1, k as N$1, _, O as O$1 } from './usePopper-jS7FPPLV.mjs';
...
let ge = defineComponent({ name: "Menu", props: { as: { type: [Object, String], default: "template" } }, setup(o$12, { slots: M, attrs: i$12 }) {
  ...
  }, computed(() => I2.value === 0)), provide(A, l2), t(computed(() => u$4(I2.value, { [0]: i.Open, [1]: i.Closed }))), () => {
    let t2 = { open: I2.value === 0, close: l2.closeMenu };
    return A$1({ ourProps: {}, theirProps: o$12, slot: t2, slots: M, attrs: i$12, name: "Menu" });
  };
} }), Se = defineComponent({ name: "MenuButton", props: { disabled: { type: Boolean, default: false }, as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(o$2$1, { attrs: M, slots: i2, expose: I$1$1 }) {
  var b;
  let p2 = (b = o$2$1.id) != null ? b : `headlessui-menu-button-${I$1()}`, e = O("MenuButton");
...
} }), Me = defineComponent({ name: "MenuItems", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, id: { type: String, default: null } }, setup(o$2$1, { attrs: M, slots: i$2, expose: I$1$1 }) {
  var l$12;
  let p2 = (l$12 = o$2$1.id) != null ? l$12 : `headlessui-menu-items-${I$1()}`, e = O("MenuItems"), r = ref(null);
  ...
  return () => {
    ...
    return A$1({ ourProps: n, theirProps: a, slot: t2, attrs: M, slots: i$2, features: N.RenderStrategy | N.Static, visible: b.value, name: "MenuItems" });
  };
} }), be = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: null } }, setup(o$12, { slots: M, attrs: i2, expose: I$1$1 }) {
  var v2;
...
//# sourceMappingURL=Dropdown-ClBfsRGA.mjs.map
