...
import { o as o$2, u as u$3, y as c, x as f$1, w, t as t$1, d as i, E, A as A$1, T, I as I$1, s as s$1, i as i$3, N as N$1, l, p as i$1, r as u$1, m as w$2, n as h$1, q as p, v as usePopper, h as l$1, O, a as o$1$1, B as n$1 } from './usePopper-DnPFaP2s.mjs';
import { f as f$2, s, t as t$2 } from './micro-task-DbFZIhYP.mjs';
...
let ie = Symbol("VirtualContext"), ke = defineComponent({ name: "VirtualProvider", setup(a, { slots: T2 }) {
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [...l2 != null && k.value != null ? e({ [l2]: k.value }).map(([U, ue]) => h(f$2, E({ features: s.Hidden, key: U, as: "input", type: "hidden", hidden: true, readOnly: true, form: f2, name: U, value: ue }))) : [], A$1({ theirProps: { ...r, ...T(p2, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: O2, slots: T$1, attrs: r, name: "Combobox" })]);
  };
} });
...
let Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (o2) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(o2, { slots: b, attrs: r, emit: w$2$1 }) {
  ...
  return onMounted(() => {
    ...
    return h(Fragment, [...t2 != null && M.value != null ? e({ [t2]: M.value }).map(([I2, Q]) => h(f$2, E({ features: s.Hidden, key: I2, as: "input", type: "hidden", hidden: true, readOnly: true, form: d2, name: I2, value: Q }))) : [], A$1({ ourProps: {}, theirProps: { ...r, ...T(O2, ["defaultValue", "onUpdate:modelValue", "horizontal", "multiple", "by"]) }, slot: h$12, slots: b, attrs: r, name: "Listbox" })]);
  };
} });
...
//# sourceMappingURL=SelectMenu-32_eluQV.mjs.map
