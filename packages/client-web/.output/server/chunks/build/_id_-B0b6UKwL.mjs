...
import { i as useRoute, a as __nuxt_component_0$3, k as __nuxt_component_2$1 } from './server.mjs';
...
import { defineAsyncComponent, defineComponent, computed, withCtx, createVNode, unref, toDisplayString, openBlock, createBlock, Suspense, createTextVNode, createCommentVNode, Fragment, renderList, useSSRContext } from 'vue';
...
const __nuxt_component_7_lazy = defineAsyncComponent(() => import('./DetailWidget-BnB9RJA1.mjs').then((c) => c.default || c));
const __nuxt_component_8_lazy = defineAsyncComponent(() => import('./StatWidget-B-FbS7lu.mjs').then((c) => c.default || c));
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LazySessionWidgetStatWidget = __nuxt_component_8_lazy;
...
//# sourceMappingURL=_id_-B0b6UKwL.mjs.map
