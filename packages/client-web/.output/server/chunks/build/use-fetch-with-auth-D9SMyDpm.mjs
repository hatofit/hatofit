import { h as useAuth, L as fetchDefaults, B as useNuxtApp, J as asyncDataDefaults, M as useRequestFetch, K as createError } from './server.mjs';
...
import { g as getApiUrl } from './api-Bs5Sh9SF.mjs';
...
const useFetchWithAuth = (urlStr, opts = {}) => {
  var _a, _b;
  const $auth = useAuth();
  return useFetch(urlStr, {
    baseURL: getApiUrl(),
    headers: {
...
export { useFetch as a, useFetchWithAuth as u };
//# sourceMappingURL=use-fetch-with-auth-D9SMyDpm.mjs.map
