...
import { defineComponent, toRef, computed, cloneVNode, h, useSSRContext, resolveComponent, mergeProps, withCtx, createVNode, unref, openBlock, createBlock, Fragment, renderList, toDisplayString } from 'vue';
import { twJoin } from 'tailwind-merge';
import { m as mergeConfig, b as appConfig, c as __nuxt_component_0$2, f as useUI, T as getSlotsChildren, h as useAuth, _ as _export_sfc } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UMeterGroup = __nuxt_component_1;
      const _component_UMeter = __nuxt_component_2;
      ...
      _push(ssrRenderComponent(_component_UCard, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            ssrRenderList([
              ["Age", Math.abs(Number(unref($dayjs)((_a = unref($auth).data.value) == null ? void 0 : _a.user["dateOfBirth"]).diff(unref($dayjs)(), "year")))],
              ["Recomendation Max HR", 208 - 0.7 * 30]
            ], (stat, j) => {
              _push2(`<div class="text-center"${_scopeId}><div class="mb-2"${_scopeId}>${ssrInterpolate(stat[0])}</div><div class="text-5xl"${_scopeId}>${ssrInterpolate(stat[1])}</div></div>`);
            });
            _push2(`<!--]--></div>`);
          } else {
            return [
              createVNode("div", { class: "flex justify-around mb-6" }, [
                (openBlock(true), createBlock(Fragment, null, renderList([
                  ["Age", Math.abs(Number(unref($dayjs)((_b = unref($auth).data.value) == null ? void 0 : _b.user["dateOfBirth"]).diff(unref($dayjs)(), "year")))],
                  ["Recomendation Max HR", 208 - 0.7 * 30]
                ], (stat, j) => {
...
//# sourceMappingURL=StatWidget-B-FbS7lu.mjs.map
