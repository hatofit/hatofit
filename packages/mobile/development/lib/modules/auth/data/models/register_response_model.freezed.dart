...
/// @nodoc
@JsonSerializable()
class _$RegisterResponseModelImpl extends _RegisterResponseModel {
  const _$RegisterResponseModelImpl(
      {this.success, this.message, this.user, this.token})
      : super._();
  ...
  @override
  String toString() {
    return 'RegisterResponseModel(success: $success, message: $message, user: $user, token: $token)';
  }
...
abstract class _RegisterResponseModel extends RegisterResponseModel {
  const factory _RegisterResponseModel(
      {final bool? success,
      final String? message,
      final UserModel? user,
      final String? token}) = _$RegisterResponseModelImpl;
  const _RegisterResponseModel._() : super._();
